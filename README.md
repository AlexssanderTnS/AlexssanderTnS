...
<h2 align="justify">Estou me aventurando no mundo de Inteligências Artificiais, atualmente desenvolvendo uma para atuação de suporte acadêmico baseada em RAG e LLM para servir de apoio para os alunos de determinado curso, sendo uma companheira prestativa nos estudos ou apenas uma fonte de consulta do material disponibilizado e criando uma para um dos meus passatempos que será para o RPG Ordem Paranormal criado pelo Cellbit, ela servirá para ajudar jogadores a criar fichas, entender mecânicas, instruções dos guias, livro de regras ou até mesmo para conhecer mais esse mundo fictício </h2>
